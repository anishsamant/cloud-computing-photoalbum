    ...
    apigClient.searchGet(params, {}, {})
        .then(function(result) {
            ...
            for (n = 0; n < results.length; n++) {
                ...
                photosDiv.innerHTML += '<figure class="img-class"><img src="' + results[n].url + '" style="width:100%"><figcaption align="center">' + imageName + '</figcaption></figure>';
            }
...
function uploadPhoto() {
    ...
    if ((filePath == "") || (!['png', 'jpg', 'jpeg'].includes(filePath[2].split(".")[1]))) {
        ...
        reader.onload = function (event) {
            ...
            fetch(`https://rylxminj0k.execute-api.us-east-1.amazonaws.com/photoalbum1/upload/cc-photoalbum1/${filePath[2]}`, requestOptions)
